<template>
    <div class="p-8 rounded-lg shadow-lg">
      <h1 class="text-3xl font-bold mb-6 text-center text-white">Stats</h1>
  
      <div class="justify-around">
        <div class="card w-full h-[20rem] mb-8 bg-light-primary-color">
        ...
        <div class="card h-full w-full mb-8 bg-light-primary-color">
