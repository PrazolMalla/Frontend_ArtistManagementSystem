        ...
        <fieldset class="border border-slate-700 rounded-md">
            ...
            <div class="form-container  w-full p-10 h-full bg-dark-primary-color  flex flex-wrap justify-start gap-5  align-middle">
                ...
                <div v-for="item in userInputField" :key="item.id" class="w-full sm:w-5/12   text-white">
                  <label :for="item.name" class="text-sm  font-helvetica text-slate-300 pl-3">
                   ...
                   <div class="w-full sm:w-2/12  text-white flex flex-col mt-2">
                    ...
                    <div class="w-full sm:w-2/12  text-white flex flex-col mt-2">
                      <label for="img" class="cursor-pointer items-center p-2 text-sm text-gray-900 bg-gray-50 rounded-full focus-within:outline-none focus-within:border-hover-yellow focus-within:ring focus-within:ring-btn-yellow focus-within:ring-opacity-50">File(mp3/mp4)</label>
                      <input type="file" id="img" name="profile" @change="handleFileChange"  class="hidden " >
                ...
                <div class="w-full text-center">
                  ...
                  <label for="isArtist"  class=" p-2 text-slate-100 hover:text-secondary-color" >Are you adding this music as (XYZ)  Band?</label>
                </div>
                <div class="w-full flex justify-center gap-2 align-middle">
                      <button
                      class="bg-btn-yellow h-10 w-full sm:w-2/6 hover:text-secondary-color text-slate-200 text-md rounded-full hover:border hover:bg-transparent border-secondary-color bg-secondary-color"
